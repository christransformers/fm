          ...
          {chartData.slice(0, 3).map((track) => (
            <div key={track.rank} className="bg-sc-bg-secondary rounded-lg overflow-hidden border border-sc-border">
              <div className="p-4 flex items-center gap-3">
                <span className="text-3xl font-extrabold text-sc-text-tertiary">#{track.rank}</span>
        ...
        <div className="mt-12">
          ...
          <div className="bg-sc-bg-secondary rounded-lg overflow-hidden border border-sc-border">
            <iframe
              ...
              frameBorder="no"
              allow="autoplay"
              src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/1704655892&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"
              className="w-full"
            />
          </div>
